...
\begin{itemize}
	\item Da der Code sowieso öffentlich auf Github zur Verfügung gestellt wird, soll das Deployment mithilfe einer Continous Integration (CI)\nomenclature{CI}{Continous Integration} automatisiert werden, sodass die aktuellste Binary als Release zur Verfügung gestellt wird, wobei diese dann auch direkt für OTA Updates genutzt werden können.
